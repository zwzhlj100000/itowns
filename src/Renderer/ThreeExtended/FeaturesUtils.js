...
function isFeatureSingleGeometryUnderCoordinate(coordinate, type, geometry, epsilon) {
...
function isFeatureUnderCoordinate(coordinate, feature, epsilon, result) {
    for (const geometry of feature.geometry) {
        const under = isFeatureSingleGeometryUnderCoordinate(coordinate, feature.type, geometry, epsilon);
        if (under) {
            result.push({
                feature,
